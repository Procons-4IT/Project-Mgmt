            ...
            If choice = "MODULE" Then
                ...
                If ItemCode <> "" And ItemCode <> "" Then
                    If Documentchoice = "" Then
                        ...
                        strSQL = "Select U_Z_MODNAME,sum(U_Z_HOURS) from " & CFLChoice & " where DocEntry= (Select DocEntry from [@Z_HPRJ] where U_Z_PRJCODE='" & ItemCode & "')  and U_Z_EMPID  in (" & strEMPIDS & ") group by U_Z_MODNAME"
            ...
            ElseIf choice = "ACTIVITY" Or choice = "ACTIVITY1" Or choice = "ACTIVITY2" Or choice = "ACTIVITY3" Then
                ...
                If ItemCode <> "" And ItemCode <> "" Then
                    If Documentchoice = "" Then
                        ...
                        strSQL = "Select U_Z_ActName,U_Z_MODNAME,U_Z_Hours ,U_Z_CNTID,U_Z_POSITION,U_Z_BOQ,U_Z_CUSTCNTID from " & CFLChoice & " where DocEntry= (Select DocEntry from [@Z_HPRJ] where U_Z_PRJCODE='" & ItemCode & "')  and U_Z_EMPID  in (" & strEMPIDS & ")"
                        dtTemp.ExecuteQuery(strSQL)
                        objGrid.DataTable = dtTemp
                    Else
                        ...
                        strSQL = "Select U_Z_ActName,U_Z_MODNAME,U_Z_Hours,U_Z_CNTID,U_Z_POSITION ,U_Z_BOQ,U_Z_CUSTCNTID from " & CFLChoice & " where DocEntry= (Select DocEntry from [@Z_HPRJ] where U_Z_PRJCODE='" & ItemCode & "')and U_Z_MODNAME='" & Documentchoice & "'  and U_Z_EMPID  in (" & strEMPIDS & ") "
                        dtTemp.ExecuteQuery(strSQL)
                        objGrid.DataTable = dtTemp
                    End If
                    'strSQL = "Select U_BinCode,U_Descrip,U_OnHand from [@DABT_OITBL] where U_ItemCode='" & ItemCode & "'and  U_WhsCode='" & CFLChoice & "' Order by U_BinCode "
