...
#Region "Methods"
    ...
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_LeaveType) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_LeaveType, frm_LeaveType)
...
#Region "DataBind"
    ...
    Public Sub BindData(ByVal objform As SAPbouiCOM.Form)
        ...
        Try
            ...
            oDBDataSrc = objform.DataSources.DBDataSources.Add("@Z_LEAVETYPE")
            Try
                oDBDataSrc.Query()
...
#Region "Enable Matrix After Update"
    ...
    Private Sub EnblMatrixAfterUpdate(ByVal objApplication As SAPbouiCOM.Application, ByVal ocompany As SAPbobsCOM.Company, ByVal oForm As SAPbouiCOM.Form)
        ...
        Try
            ...
            If oMatrix.Columns.Item(1).Cells.Item(oMatrix.RowCount).Specific.value = "" Then
                oUserTable = ocompany.UserTables.Item("Z_LEAVETYPE")
                oDBDSource = oForm.DataSources.DBDataSources.Item("@Z_LEAVETYPE")
                ...
                For i = 0 To oDBDSource.Size - 1
                    If oUserTable.GetByKey(oDBDSource.GetValue("Code", i)) Then
                        ...
                        '  oUserTable.UserFields.Fields.Item("U_Z_LeaveType").Value = oDBDSource.GetValue("U_Z_LeaveType", i)
                        oUserTable.UserFields.Fields.Item("U_Z_Status").Value = oDBDSource.GetValue("U_Z_Status", i)
                        oUserTable.UserFields.Fields.Item("U_Z_Name").Value = oDBDSource.GetValue("U_Z_Name", i)
...
#Region "Insert Code and Doc Entry"
    ...
    Public Sub InsertCodeAndDocEntry(ByVal aForm As SAPbouiCOM.Form)
        ...
        Try
            objForm = aForm
            objForm.Freeze(True)
            oDBDSource = objForm.DataSources.DBDataSources.Item("@Z_LEAVETYPE")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_LeaveType Then
                        ...
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "3" And pVal.ColUID = "V_0" And pVal.CharPressed = 9 Then
                                    ...
                                    strValue = oApplication.Utilities.getMatrixValues(objMatrix, "V_3", pVal.Row)
                                    If oApplication.Utilities.validaterecordexists(strValue, "U_Z_NAME", "U_Z_NAME") = True Then
                                        oApplication.Utilities.Message("Leave Type already exists", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                        objMatrix.Columns.Item("V_3").Cells.Item(pVal.Row).Click(SAPbouiCOM.BoCellClickType.ct_Right, 1)
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
                                End If
