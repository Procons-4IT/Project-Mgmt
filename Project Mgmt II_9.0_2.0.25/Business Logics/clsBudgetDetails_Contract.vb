Public Class clsBudgetDetails_Contract
    Inherits clsBase
...
#Region "Methods"
    ...
    Public Sub LoadForm(ByVal aCode As String)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_BudgetContract) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_BudgetContract, frm_BudgetContract)
        ...
        oRecset.DoQuery("Select  * from ""@Z_OPAT"" where DocEntry=" & aCode)
        oApplication.Utilities.setEdittextvalue(oForm, "35", oRecset.Fields.Item("U_Z_CARDCODE").Value)
        oApplication.Utilities.setEdittextvalue(oForm, "37", oRecset.Fields.Item("U_Z_CARDNAME").Value)
        oApplication.Utilities.setEdittextvalue(oForm, "19", oRecset.Fields.Item("U_Z_STARTDATE").Value)
        oApplication.Utilities.setEdittextvalue(oForm, "21", oRecset.Fields.Item("U_Z_ENDDATE").Value)
        Dim STSTATUS As String = oRecset.Fields.Item("U_Z_STATUS").Value
        oCombobox = oForm.Items.Item("17").Specific
        oCombobox.Select(STSTATUS, SAPbouiCOM.BoSearchKey.psk_ByValue)
...
#Region "Add Choose From List"
    ...
    Private Sub AddChooseFromList_Conditions_SalesOrder(ByVal objForm As SAPbouiCOM.Form, ByVal aRow As Integer)
        Try
            ...
            Dim strPrj As String = oCombobox.Selected.Value
    ...
    Private Sub LoadGridValues(ByVal aForm As SAPbouiCOM.Form)
        ...
        Try
            ...
            If strProject <> "" Then
                ...
                'oTest.DoQuery("Select * from [@Z_HPRJ] T0 inner Join [@Z_PRJ1] T1 on T1.DocEntry=T0.DocEntry and T1.U_Z_CNTID='" & strProject & "'")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_BudgetContract Then
