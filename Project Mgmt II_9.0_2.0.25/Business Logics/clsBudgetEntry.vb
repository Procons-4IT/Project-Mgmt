...
#Region "Methods"
    ...
    Private Sub LoadForm()
        ...
        '    oDataSrc_Line.SetValue("LineId", count - 1, count)
        'Next
        oForm.DataSources.UserDataSources.Add("cmbFilter", SAPbouiCOM.BoDataType.dt_SHORT_TEXT)
        oForm.DataSources.UserDataSources.Add("cmbSort", SAPbouiCOM.BoDataType.dt_SHORT_TEXT)

        oCombobox = oForm.Items.Item("52").Specific
        oCombobox.DataBind.SetBound(True, "", "cmbFilter")
        oCombobox.ValidValues.Add("", "")
        oCombobox.ValidValues.Add("T1.U_Z_MODNAME", "Phase")
        oCombobox.ValidValues.Add("T1.U_Z_STATUS", "Status")

        oForm.Items.Item("52").DisplayDesc = True

        oCombobox = oForm.Items.Item("54").Specific
        oCombobox.DataBind.SetBound(True, "", "cmbSort")
        oCombobox.ValidValues.Add("", "")
        oCombobox.ValidValues.Add("T1.U_Z_MODNAME", "Phase")
        oCombobox.ValidValues.Add("T1.U_Z_FROMDATE", "Start Date")
        oCombobox.ValidValues.Add("T1.U_Z_TODATE", "End Date")
        oCombobox.ValidValues.Add("T1.U_Z_STATUS", "Status")
        oForm.Items.Item("54").DisplayDesc = True
...
#Region "AddRow /Delete Row"
    ...
    Private Function ValidateDeletion(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        If oGrid.DataTable.GetValue("U_Z_MODNAME", intSelectedMatrixrow) <> "" Then
            ...
            strProcess = oApplication.Utilities.getEdittextvalue(aForm, "4")
            ...
            Dim strEmpID As String = oGrid.DataTable.GetValue("U_Z_EMPID", intSelectedMatrixrow)
            ...
            otemp.DoQuery("select * from [@Z_OTIM] T0 Inner Join [@Z_TIM1] T1 on T1.U_Z_REFCODE=T0.Code where U_Z_EMPCODE='" & strEmpID & "' and  U_Z_PRJCODE='" & strPrjCode & "' and U_Z_PRCNAME='" & strProcess.Replace("'", "''") & "' and U_Z_ACTNAME='" & strActivity.Replace("'", "''") & "'")
            If otemp.RecordCount > 0 Then
                ...
                Return False
            End If
            otemp.DoQuery("select * from [@Z_OEXP] T0 Inner Join [@Z_EXP1] T1 on T1.U_Z_REFCODE=T0.Code where U_Z_EMPCODE='" & strEmpID & "' and  U_Z_PRJCODE='" & strPrjCode & "' and U_Z_MODNAME='" & strProcess.Replace("'", "''") & "' and U_Z_ACTNAME='" & strActivity.Replace("'", "''") & "'")
            If otemp.RecordCount > 0 Then
                strMessage = "Project Code : " & strPrjCode & " , Phase : " & strProcess & " , Activity : " & strActivity
        ...
        Try
            ...
            For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
                ...
                If strCode <> "" Then
                    ...
                    If strActivity = "" Then
                        oApplication.Utilities.Message("Activity detail is missing . Line Number : " & intRow + 1, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        aform.Freeze(False)
                        Return False
                    End If
                    ...
                    If 1 = 1 Then 'oCombobox.Selected.Value = "R" Then
                        ...
                        If strcode1 = "" Then
                            oApplication.Utilities.Message("No of Hours is missing . Line Number : " & intRow + 1, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        ...
                        If CInt(strcode1) <= 0 Then
                            ...
                            Return False
                        Else
                            dblHours = oApplication.Utilities.getDocumentQuantity(strcode1)
                            dblHours = dblHours / 8
                            oGrid.DataTable.SetValue("U_Z_DAYS", intRow, dblHours)
                        End If
                    End If
                    strHours = oGrid.DataTable.GetValue("U_Z_DAYS", intRow)
                    '   strHours = oGrid.DataTable.GetValue("U_Z_HOURS", intRow)
                    If strHours <> "" Then
                    ...
                    Try
                        If oCombocolumn.GetSelectedValue(intRow).Value = "C" Then
                            If strdate = "" Then
                                oApplication.Utilities.Message("Completion date is missing. Line Number  : " & intRow + 1, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                oForm.Items.Item("10").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                    ...
                    If strdate = "" Then
                        oApplication.Utilities.Message("From date is missing. Line Number  : " & intRow + 1, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        oForm.Items.Item("10").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                    ...
                    Else
                        ...
                        Else
                            oApplication.Utilities.Message("From date should be between project budget From and End date. Line Number  : " & intRow + 1, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                            '  oForm.Items.Item("10").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                            ' oGrid.Columns.Item("U_Z_FROMDATE").Click(intRow)
                            ' aform.Freeze(False)
                            '  Return False
                    ...
                    If strdate = "" Then
                        oApplication.Utilities.Message("End date is missing. Line Number  : " & intRow + 1, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        oForm.Items.Item("10").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                    ...
                    Else
                        ...
                        If dtDate >= dtFrom And dtDate <= dtTo Then
                        Else
                            oApplication.Utilities.Message("End date should be between project budget From and End date. Line Number  : " & intRow + 1, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                            ' oForm.Items.Item("10").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                            ' oGrid.Columns.Item("U_Z_TODATE").Click(intRow)
                            '  aform.Freeze(False)
                            '  Return False
...
#Region "LoadGridValues"
        ...
        Try
            ...
            If strProject <> "" Then
                ...
                If oApplication.Utilities.CheckSuperUser(intEmp) = False Then
                    oTest.DoQuery("Select * from OPRJ where PrjCode='" & strProject & "' and U_Z_EMPID='" & intEmp & "'")
                    If oTest.RecordCount > 0 Then
                    Else
                        oApplication.Utilities.Message("You are not authorized to view this project budget details", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        strProject = ""
                    End If
                End If
            End If
            ...
            strProject = strProject ' oCombobox.Selected.Value
            oTest = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            otest.DoQuery("Select isnull(U_Z_CARDCODE,''),*  from OPRJ where prjCode='" & strProject & "'")
            '   strProject = otest.Fields.Item(0).Value
            oCheckBox = oForm.Items.Item("48").Specific
            If oTest.RecordCount > 0 Then
                oApplication.Utilities.setEdittextvalue(oForm, "edEmp", oTest.Fields.Item("U_Z_EMPID").Value)

                Dim strFrom, strTo As String
                strFrom = oApplication.Utilities.getEdittextvalue(aForm, "19")
                strTo = oApplication.Utilities.getEdittextvalue(aForm, "21")
                If strFrom = "" Then
                    strFrom = oTest.Fields.Item("ValidFrom").Value
                    If strFrom <> "0:00:00" Then
                        oApplication.Utilities.setEdittextvalue(aForm, "19", strFrom)
                    End If


                End If
                If strTo = "" Then
                    strTo = oTest.Fields.Item("ValidTo").Value
                    If strTo <> "0:00:00" Then
                        oApplication.Utilities.setEdittextvalue(aForm, "21", strTo)
                    End If

                End If

                Dim empID As String
                empID = oTest.Fields.Item("U_Z_EMPID").Value
                If oTest.Fields.Item("U_Z_INTERNAL").Value = "Y" Then
                    oCheckBox.Checked = True
                Else
                    oCheckBox.Checked = False
                End If
                ...
                If empID <> "" Then
                    oTest.DoQuery("Select isnull(firstName,'')+' ' + isnull(lastName,'') from OHEM where empid=" & empID)
                    oApplication.Utilities.setEdittextvalue(oForm, "49", oTest.Fields.Item(0).Value)
                Else
                    oApplication.Utilities.setEdittextvalue(oForm, "49", " ")
                    oApplication.Utilities.setEdittextvalue(oForm, "edEmp", "")
                End If
            Else
    ...
    Private Sub FillValueCombo(ByVal aForm As SAPbouiCOM.Form)
        ...
        ElseIf strFieldchoice = "T1.U_Z_MODNAME" Then
            oCombobox = aForm.Items.Item("55").Specific
            For intRow As Integer = oCombobox.ValidValues.Count - 1 To 0 Step -1
                Try
                    oCombobox.ValidValues.Remove(intRow, SAPbouiCOM.BoSearchKey.psk_Index)
            ...
            oTes.DoQuery("Select T1.U_Z_MODNAME,Count(*) from ""@Z_HPRJ"" T0 Inner Join ""@Z_PRJ1"" T1 on T1.""DocEntry""=T0.""DocEntry"" where T0.""U_Z_PRJCODE""='" & strProject & "' Group by T1.U_Z_MODNAME")
            For intLoop As Integer = 0 To oTes.RecordCount - 1
                oCombobox.ValidValues.Add(oTes.Fields.Item("U_Z_MODNAME").Value, oTes.Fields.Item("U_Z_MODNAME").Value)
                oTes.MoveNext()
            Next
            oCombobox.Select(0, SAPbouiCOM.BoSearchKey.psk_Index)
        Else
            ...
            oCombobox.Select(0, SAPbouiCOM.BoSearchKey.psk_Index)
        End If
        aForm.Items.Item("55").DisplayDesc = True
        oCombobox = aForm.Items.Item("55").Specific
        oCombobox.ExpandType = SAPbouiCOM.BoExpandType.et_DescriptionOnly
    End Sub
    Private Sub LoadGridValues_Filter(ByVal aForm As SAPbouiCOM.Form)
        Dim strQuery, strProject As String
        Try
            ...
            Else
                ...
                End If
            End If
            oCombobox = aForm.Items.Item("54").Specific
            Try
            ...
            'End If
            If strSortBy = "" Then
                strSortBy = "  Order by T1.U_Z_MODNAME,T1.U_Z_ACTNAME,T1.U_Z_FROMDATE"
            Else
                If strSortBy = "T1.U_Z_FROMDATE" Then
                    strSortBy = "  Order by   " & strSortBy & ",T1.U_Z_TODATE,T1.U_Z_MODNAME,T1.U_Z_ACTNAME"
                ElseIf strSortBy = "T1.U_Z_TODATE" Then
                    strSortBy = "  Order by   " & strSortBy & ",T1.U_Z_FROMDATE,T1.U_Z_MODNAME,T1.U_Z_ACTNAME"
                ElseIf strSortBy = "T1.U_Z_MODNAME" Then
                    strSortBy = "  Order by   " & strSortBy & ",T1.U_Z_FROMDATE,T1.U_Z_TODATE,T1.U_Z_ACTNAME"
                Else

                    strSortBy = "  Order by   " & strSortBy & ",T1.U_Z_FROMDATE,T1.U_Z_TODATE,T1.U_Z_MODNAME,T1.U_Z_ACTNAME"
                End If
            End If
            Dim oTest, otest1 As SAPbobsCOM.Recordset
            oTest = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            ...
            If strProject <> "" Then
                ...
                strQuery = "select T1.DocEntry,T1.LineId,T1.U_Z_MODNAME ,T1.U_Z_ACTNAME,T1.U_Z_TYPE,T1.U_Z_CNTID,T1.U_Z_EMPID, T1.U_Z_POSITION, T1.U_Z_FROMDATE, T1.U_Z_TODATE, T1.U_Z_QUANTITY, T1.U_Z_MEASURE, T1.U_Z_DAYS, T1.U_Z_HOURS, T1.U_Z_AMOUNT, T1.U_Z_ORDER ,T1.U_Z_ORDENTRY,T1.U_Z_ORDNUM ,T1.U_Z_STATUS,T1.U_Z_CMPDATE,T1.U_Z_BOQ,T1.U_Z_EXPTYPE  from [@Z_HPRJ] T0 inner Join [@Z_PRJ1] T1 on T1.DocEntry=T0.DocEntry where T0.U_Z_PRJCODE='" & strProject & "'"
                strQuery = strQuery & " and " & strField & strSortBy
                oGrid = aForm.Items.Item("100").Specific
                oGrid.DataTable.ExecuteQuery(strQuery)
            Else
                strQuery = "select T1.DocEntry,T1.LineId,T1.U_Z_MODNAME ,T1.U_Z_ACTNAME,T1.U_Z_TYPE,T1.U_Z_CNTID,T1.U_Z_EMPID, T1.U_Z_POSITION, T1.U_Z_FROMDATE, T1.U_Z_TODATE, T1.U_Z_QUANTITY, T1.U_Z_MEASURE, T1.U_Z_DAYS, T1.U_Z_HOURS, T1.U_Z_AMOUNT, T1.U_Z_ORDER ,T1.U_Z_ORDENTRY,T1.U_Z_ORDNUM ,T1.U_Z_STATUS,T1.U_Z_CMPDATE,T1.U_Z_BOQ,T1.U_Z_EXPTYPE  from [@Z_HPRJ] T0 inner Join [@Z_PRJ1] T1 on T1.DocEntry=T0.DocEntry where 1=2"
    ...
    Private Sub PopulateBudgetfromTemplate(ByVal aForm As SAPbouiCOM.Form, ByVal aDocEntry As String)
        ...
        Try
            ...
            If strProject <> "" Then
                ...
                '    oTest.MoveNext()
                'Next
                strQuery = "select T1.DocEntry,T1.LineId,T1.U_Z_MODNAME ,T1.U_Z_ACTNAME,T1.U_Z_TYPE ,'     ' 'U_Z_CNTID',T1.U_Z_EMPID, T1.U_Z_POSITION, T1.U_Z_FROMDATE, T1.U_Z_TODATE, T1.U_Z_QUANTITY, T1.U_Z_MEASURE, T1.U_Z_DAYS, T1.U_Z_HOURS, T1.U_Z_AMOUNT, T1.U_Z_ORDER ,T1.U_Z_ORDENTRY,T1.U_Z_ORDNUM ,T1.U_Z_STATUS,T1.U_Z_CMPDATE,T1.U_Z_BOQ ,T1.U_Z_EXPTYPE from [@Z_DHPRJ] T0 inner Join [@Z_DPRJ1] T1 on T1.DocEntry=T0.DocEntry where T1.U_Z_TYPE='R'  and T0.U_Z_PRJCODE='" & strProject & "'"
...
#End Region
    ...
    Private Sub FormatGrid(ByVal aform As SAPbouiCOM.Form, ByVal aGrid As SAPbouiCOM.Grid, ByVal aChoice As String)
        Try
            ...
            Else
                aGrid.Columns.Item("U_Z_EMPID").Visible = True
                aGrid.Columns.Item("U_Z_POSITION").Visible = True
            End If
            oEditTextColumn = aGrid.Columns.Item("U_Z_ORDENTRY")
...
#End Region
    ...
    Private Function AddUDT(ByVal aform As SAPbouiCOM.Form, ByVal aDocEntry As Integer) As Boolean
        Try
            ...
            oApplication.Utilities.setEdittextvalue(aform, "edEmp", oRec.Fields.Item("U_Z_EMPID").Value)
            oApplication.Utilities.setEdittextvalue(aform, "49", oRec.Fields.Item("U_Z_EMPNAME").Value)
            ...
            strCardCode1 = oApplication.Utilities.getEdittextvalue(aform, "35")
            strCardName = oApplication.Utilities.getEdittextvalue(aform, "37")
            strEmpID1 = oApplication.Utilities.getEdittextvalue(aform, "edEmp")
            strEMPName = oApplication.Utilities.getEdittextvalue(aform, "49")
            Dim dblTotalHour As Double = oApplication.Utilities.getDocumentQuantity(oApplication.Utilities.getEdittextvalue(aform, "edTotHours"))
            Dim dblTotalCost As Double = oApplication.Utilities.getDocumentQuantity(oApplication.Utilities.getEdittextvalue(aform, "edTotCost"))
...
#End Region
    ...
    Private Function AddtoUDT(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        Else
            ...
            oApplication.Utilities.setEdittextvalue(aForm, "edEmp", " ")
            oApplication.Utilities.setEdittextvalue(aForm, "49", " ")
            oCheckBox.Checked = False
        End If

        UpdateTotalHoursandCost(aForm)
    ...
    Private Sub PopulateProjectDetails(ByVal aform As SAPbouiCOM.Form)
        ...
        Try
            ...
            '  strProject = otest.Fields.Item(0).Value
            oCheckBox = oForm.Items.Item("48").Specific
            If otest.RecordCount > 0 Then ' strProject <> "" Then
                oApplication.Utilities.setEdittextvalue(oForm, "edEmp", otest.Fields.Item("U_Z_EMPID").Value)
                Dim strFrom, strTo As String
                strFrom = oApplication.Utilities.getEdittextvalue(aform, "19")
                strTo = oApplication.Utilities.getEdittextvalue(aform, "21")
...
#Region "Update total number of Hours and Cost"
    Private Sub UpdateTotalHoursandCost(ByVal aform As SAPbouiCOM.Form)
        Try
            aform.Freeze(True)
            Dim dblTotalhours, dblTotalCost As Double
            oGrid = aform.Items.Item("26").Specific
            dblTotalCost = 0
            dblTotalhours = 0

            For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
                dblTotalhours = dblTotalhours + oGrid.DataTable.GetValue("U_Z_HOURS", intRow)
                dblTotalCost = dblTotalCost + oGrid.DataTable.GetValue("U_Z_AMOUNT", intRow)
            Next
            oGrid = aform.Items.Item("27").Specific
            For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
                dblTotalhours = dblTotalhours + oGrid.DataTable.GetValue("U_Z_HOURS", intRow)
            ...
            For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
                ...
                dblTotalCost = dblTotalCost + oGrid.DataTable.GetValue("U_Z_AMOUNT", intRow)
            Next
            dblTotalhours = dblTotalhours ' / 8.0
            oApplication.Utilities.setEdittextvalue(aform, "edTotHours", dblTotalhours)
            oApplication.Utilities.setEdittextvalue(aform, "edTotCost", dblTotalCost)
                    ...
                    Case True
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_PICKER_CLICKED
                                ...
                                If (pVal.ItemUID = "26" Or pVal.ItemUID = "28") And pVal.ColUID = "U_Z_CNTID" Then
                                    oGrid = oForm.Items.Item(pVal.ItemUID).Specific
                                ...
                                If (pVal.ItemUID = "26" Or pVal.ItemUID = "28") And pVal.ColUID = "U_Z_EMPID" Then
                                    oGrid = oForm.Items.Item(pVal.ItemUID).Specific
                    ...
                    Case False
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_COMBO_SELECT
                                ...
                                End If
                                If pVal.ItemUID = "55" Or pVal.ItemUID = "54" Then
                                    LoadGridValues_Filter(oForm)
                                End If
                                ...
                                If (pVal.ItemUID = "26" Or pVal.ItemUID = "27" Or pVal.ItemUID = "28") And pVal.ColUID = "U_Z_HOURS" And pVal.CharPressed = 9 Then
                                    ...
                                    If strHours <> "" Then
                                        ...
                                        If (dblHours > 0) Then
                                            ...
                                            If oGrid.DataTable.GetValue("U_Z_CNTID", pVal.Row) <> "" Then
                                                oTest.DoQuery("Select isnull(U_Z_rate,0) from [@Z_OPAT] where DocEntry=" & oGrid.DataTable.GetValue("U_Z_CNTID", pVal.Row))
                                                dblRate = oTest.Fields.Item(0).Value
                                                dblRate = dblRate / 8.0
                                                dblRate = dblRate * oApplication.Utilities.getDocumentQuantity(strHours)
                                                oGrid.DataTable.SetValue("U_Z_DAYS", pVal.Row, dblDays)
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        If pVal.ItemUID = "63" Then
                                            ...
                                            oApplication.Utilities.setEdittextvalue(oForm, "64", val1)
                                            oApplication.Utilities.setEdittextvalue(oForm, "63", val)
                                        End If
