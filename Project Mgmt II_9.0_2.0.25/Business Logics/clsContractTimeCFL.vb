Public Class clsContractTimeCFL
    Inherits clsBase
    ...
    Public Sub databound(ByVal objform As SAPbouiCOM.Form)
        Try
            ...
            If choice = "Project" Then
                objform.Title = "Project - Selection"
                If 1 = 1 Then
                    If ContractID <> "" Then
                        ...
                        strSQL = "select U_Z_PRJCODE,U_Z_PRJNAME,T0.U_Z_STATUS,COUNT(*)  from [@Z_HPRJ] T0  inner Join [@Z_PRJ1] T1 on T1.DocEntry=T0.DocEntry where T0.U_Z_STATUS='X' and  T1.U_Z_CNTID='" & ContractID & "' group by U_Z_PRJCODE,U_Z_PRJNAME,T0.U_Z_STATUS"
                    ...
                    Else
                        ...
                        strSQL = "select U_Z_PRJCODE,U_Z_PRJNAME,T0.U_Z_STATUS,COUNT(*)  from [@Z_HPRJ] T0  inner Join [@Z_PRJ1] T1 on T1.DocEntry=T0.DocEntry where T0.U_Z_STATUS='X' and  T1.U_Z_CNTID<>'' group by U_Z_PRJCODE,U_Z_PRJNAME,T0.U_Z_STATUS"
                        dtTemp.ExecuteQuery(strSQL)
                        objGrid.DataTable = dtTemp
                    End If
                    ...
                    objGrid.Columns.Item(0).TitleObject.Caption = "Project Code"
                    objGrid.Columns.Item(1).TitleObject.Caption = "Project Name"
                    objGrid.Columns.Item(2).Visible = False
                    objGrid.Columns.Item(3).Visible = False
                End If
            ElseIf choice = "ACTIVITY" Or choice = "PHASE" Then
                ...
                If 1 = 1 Then
                    ...
                    Dim stModQury As String = "Select U_Z_MODNAME from [@Z_MODULE] where U_Z_STATUS='N'"
                    If choice = "ACTIVITY" Or choice = "PHASE" Then
                        If ContractID <> "" Then
                            strSQL = "Select U_Z_MODNAME,U_Z_ACTNAME,U_Z_HOURS,U_Z_CNTID  from [@Z_PRJ1] T0 inner Join [@Z_HPRJ] T1 on T1.DocEntry=T0.DocEntry  where T0.U_Z_STATUS='I' and  T1.U_Z_PRJCODE='" & CFLChoice & "' and  T0.U_Z_CNTID='" & ContractID & "'"
                        Else
                            strSQL = "Select U_Z_MODNAME,U_Z_ACTNAME,U_Z_HOURS,U_Z_CNTID  from [@Z_PRJ1] T0 inner Join [@Z_HPRJ] T1 on T1.DocEntry=T0.DocEntry  where T0.U_Z_STATUS='I' and  T1.U_Z_PRJCODE='" & CFLChoice & "' and  T0.U_Z_CNTID<>''"
                        End If
                    Else
                ...
                End If
            Else
                objform.Title = "Sub-Contractor Employee - Selection"
                ...
                strSQL = "select T1.U_Z_EMPCODE,T1.U_Z_EMPNAME,T1.U_Z_DESIGNATION  from [@Z_OPAT] T0 inner Join [@Z_PAT2] T1 on T1.DocEntry=T0.DocEntry where T0.DocEntry=" & ContractID
                dtTemp.ExecuteQuery(strSQL)
                objGrid.DataTable = dtTemp
                objGrid.Columns.Item(0).TitleObject.Caption = "Employee Code Name"
                objGrid.Columns.Item(1).TitleObject.Caption = "Employee Name"
                objGrid.Columns.Item(2).TitleObject.Caption = "Designation"
            End If
...
#Region "Item Event"
    ...
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        BubbleEvent = True
        If pVal.FormTypeEx = frm_ContractCFL Then
                    ...
                    Try
                        ...
                        If pVal.EventType = SAPbouiCOM.BoEventTypes.et_DOUBLE_CLICK And pVal.Row <> -1 Then
                            ...
                            If ContractID <> "" Then
                                ...
                                End If
                                If choice = "Project" Then
                                    strContractID = Convert.ToString(oMatrix.DataTable.GetValue("U_Z_PRJCODE", intRowId))
                                    strContractName = Convert.ToString(oMatrix.DataTable.GetValue("U_Z_PRJNAME", intRowId))
                                End If

                                If choice = "ACTIVITY" Then
                                    strContractID = Convert.ToString(oMatrix.DataTable.GetValue("U_Z_MODNAME", intRowId))
                                    strContractName = Convert.ToString(oMatrix.DataTable.GetValue("U_Z_ACTNAME", intRowId))
                                End If

                                If choice = "EMP" Then
                                    strContractID = Convert.ToString(oMatrix.DataTable.GetValue("U_Z_EMPCODE", intRowId))
                                    strContractName = Convert.ToString(oMatrix.DataTable.GetValue("U_Z_EMPNAME", intRowId))
                                End If
                                ...
                                If choice <> "" Then
                                    ...
                                    If choice = "Project" Then
                                        ...
                                        oMatrix.DataTable.SetValue(sourceColumID, sourcerowId, strSelectedItem1)
                                        oMatrix.DataTable.SetValue("U_Z_PRJNAME", sourcerowId, strSelectedItem2)

                                    ElseIf choice = "ACTIVITY" Then
                                        oMatrix = oForm.Items.Item(ItemUID).Specific
                                        oMatrix.DataTable.SetValue(sourceColumID, sourcerowId, strSelectedItem1)
                                        oMatrix.DataTable.SetValue("U_Z_ACTNAME", sourcerowId, strSelectedItem2)
                                    ElseIf choice = "EMP" Then
                                        oMatrix = oForm.Items.Item(ItemUID).Specific
                                        oMatrix.DataTable.SetValue(sourceColumID, sourcerowId, strSelectedItem1)
                                        oMatrix.DataTable.SetValue("U_Z_EMPNAME", sourcerowId, strSelectedItem2)
                                    Else
