...
#Region "DataBind"
    Private Sub databind(ByVal aForm As SAPbouiCOM.Form, ByVal adate As Date)
        Try
            ...
            oColumn = oMatrix.Columns.Item("V_118")
            oColumn.ChooseFromListUID = "CFLC1"
            ...
            For introw As Integer = 0 To otemp.RecordCount - 1
                ...
                oApplication.Utilities.SetMatrixValues(oMatrix, "V_171", oMatrix.RowCount, otemp.Fields.Item("U_Z_DISRULE").Value)
                ...
                oApplication.Utilities.SetMatrixValues(oMatrix, "V_118", oMatrix.RowCount, otemp.Fields.Item("U_Z_CNTID").Value)
                Try
                    '  oApplication.Utilities.SetMatrixValues(oMatrix, "V_3", oMatrix.RowCount, otemp.Fields.Item("U_Z_DATE").Value)
    ...
    Private Function validation(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        For intRow As Integer = 1 To oMatrix.RowCount
            ...
            If strCode <> "" Then
                ...
                If strcode1 = "" Then
                    strcode1 = oApplication.Utilities.getMatrixValues(oMatrix, "V_118", intRow)
                    If strcode1 = "" Then
                        oApplication.Utilities.Message("Contract ID / Employee id is missing....", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        Return False
                    Else
        ...
        Else
            For intLoop As Integer = 1 To oBPGrid.RowCount
                ...
                If strEmpName <> "" Then
                    ...
                    Dim strCNTID1 As String = oApplication.Utilities.getMatrixValues(oBPGrid, "V_118", intLoop)
                    Dim strDisRule As String = oApplication.Utilities.getMatrixValues(oBPGrid, "V_171", intLoop)
                    Dim ot As SAPbobsCOM.Recordset
                    ot = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                    If strEmpid1 = "" Then
                        If strCNTID1 <> "" Then
                            ot.DoQuery("Select U_Z_CardName 'firstName' from [@Z_OPAT] where ""DocEntry""=" & strCNTID1)
                            strEmpid1 = ""
                        Else
                            ot.DoQuery("Select * from OHEM where empID=" & strEmpID)
                            strEmpid1 = strEmpID
                            strCNTID1 = ""
                        End If
                    Else
                    ...
                    If strDocref <> "" Then
                        If strLineCode = "" Then
                            ...
                            ousertable.UserFields.Fields.Item("U_Z_CNTID").Value = strCNTID1
                            ousertable.UserFields.Fields.Item("U_Z_EMPNAME").Value = strEmployeename
                            ousertable.UserFields.Fields.Item("U_Z_DISRULE").Value = strDisRule
                    ...
                    Case True
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "12" And pVal.CharPressed <> 9 And (pVal.ColUID = "V_-2" Or pVal.ColUID = "V_6" Or pVal.ColUID = "V_20" Or pVal.ColUID = "V_21" Or pVal.ColUID = "V_0" Or pVal.ColUID = "V_1" Or pVal.ColUID = "V_2" Or pVal.ColUID = "V_3" Or pVal.ColUID = "V_4" Or pVal.ColUID = "V_5") Then
                    ...
                    Case False
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "12" And pVal.ColUID = "V_171" And pVal.CharPressed = 9 Then
                                    If pVal.ColUID = "V_171" Then
                                        ...
                                        oObj.strStaticValue = oApplication.Utilities.getMatrixValues(oMatrix, pVal.ColUID, pVal.Row)
                                    ...
                                    If 1 = 1 Then
                                        ...
                                        If oCombobox.Selected.Value = "P" Then
                                            ...
                                            If strProject <> "" Then
                                                ...
                                                clsChooseFromList.BinDescrUID = oApplication.Utilities.getMatrixValues(oMatrix, "V_18", pVal.Row)
                                                clsChooseFromList.ContractID = oApplication.Utilities.getMatrixValues(oMatrix, "V_118", pVal.Row)
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        If pVal.ItemUID = "12" And pVal.ColUID = "V_118" Then
                                            val = oDataTable.GetValue("DocNum", 0)
                                            oMatrix = oForm.Items.Item("12").Specific
                                            oApplication.Utilities.SetMatrixValues(oMatrix, "V_118", pVal.Row, val)
                                        End If
