...
#Region "Methods"
    ...
    Private Sub AddChooseFromList_PRJ(ByVal objForm As SAPbouiCOM.Form)
        Try
            ...
            oCFLCreationParams.MultiSelection = False
            oCFLCreationParams.ObjectType = "Z_PRJ"
            oCFLCreationParams.UniqueID = "CFL111"
            oCFL = oCFLs.Add(oCFLCreationParams)
...
#Region "Add Choose From List"
    Private Sub AddChooseFromList(ByVal objForm As SAPbouiCOM.Form)
        Try
            ...
            oCFLCreationParams.UniqueID = "CFL1_CURR"
            oCFL = oCFLs.Add(oCFLCreationParams)
...
#Region "DataBind"
    Private Sub databind(ByVal aForm As SAPbouiCOM.Form, ByVal adate As Date)
        Try
            ...
            'otemp.DoQuery("Select U_Z_PRJCODE,U_Z_PRJNAME from [@Z_HPRJ] where U_Z_STATUS='X' order by U_Z_PRJCODE")
            ...
            oColumn = oMatrix.Columns.Item("V_2")
            oColumn.ChooseFromListUID = "CFL111"
            ...
            '   oColumn.DisplayDesc = True
            oColumn.ChooseFromListUID = "CFL1_CURR"
            ...
            For introw As Integer = 0 To otemp.RecordCount - 1
                ...
                oApplication.Utilities.SetMatrixValues(oMatrix, "V_2", oMatrix.RowCount, otemp.Fields.Item("U_Z_PRJCODE").Value)
                oApplication.Utilities.SetMatrixValues(oMatrix, "V_12", oMatrix.RowCount, otemp.Fields.Item("U_Z_PRJNAME").Value)
                ...
                oApplication.Utilities.SetMatrixValues(oMatrix, "V_6", oMatrix.RowCount, otemp.Fields.Item("U_Z_CURRENCY").Value)
                ...
                oApplication.Utilities.SetMatrixValues(oMatrix, "V_51", oMatrix.RowCount, otemp.Fields.Item("U_Z_ATTACHMENT1").Value)
                Try
                    '  oApplication.Utilities.SetMatrixValues(oMatrix, "V_3", oMatrix.RowCount, otemp.Fields.Item("U_Z_DATE").Value)
            ...
            oColumn = oMatrix.Columns.Item("V_2")
            oColumn.ChooseFromListUID = "CFL11"
            oColumn.ChooseFromListAlias = "U_Z_PRJCODE"
    ...
    Private Sub databind_ViewEntry(ByVal aForm As SAPbouiCOM.Form, ByVal adate As Date)
        Try
            ...
            oColumn.ChooseFromListAlias = "empID"
            oColumn = oMatrix.Columns.Item("V_2")
            'otemp.DoQuery("Select U_Z_PRJCODE,U_Z_PRJNAME from [@Z_HPRJ] order by U_Z_PRJCODE")
        ...
        For introw As Integer = 1 To oMatrix.RowCount
            If oMatrix.IsRowSelected(introw) Then
                ...
                If oCombobox.Selected.Value = "P" Then
                    ...
                    If strLineCode <> "" Then
                        oTemp.DoQuery("Update [@Z_EXP1] set Name=Name +'_XD' where code='" & strLineCode & "'")
                    End If
    ...
    Private Function validation(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        For intRow As Integer = 1 To oMatrix.RowCount
            ...
            If strCode <> "" Then
                ...
                strcode1 = oApplication.Utilities.getMatrixValues(oMatrix, "V_6", intRow)
                If strcode1 = "" Then
                    oApplication.Utilities.Message("Transaction Currency is missing. Line Number : " & intRow, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    Return False
                End If
                ...
                If strcode1 = "P" Then
                    ...
                    '  If oCombobox.Selected.Value = "" Then
                    If oApplication.Utilities.getMatrixValues(oMatrix, "V_2", intRow) = "" Then
        ...
        Else
            For intLoop As Integer = 1 To oBPGrid.RowCount
                ...
                If strEmpName <> "" Then
                    ...
                    strCurrency = oApplication.Utilities.getMatrixValues(oBPGrid, "V_6", intLoop)
                    ...
                    If stremptype = "P" Then
                        ...
                        strPrjCode = oApplication.Utilities.getMatrixValues(oBPGrid, "V_2", intLoop) ' oCombobox.Selected.Value
                        strprojectname = oApplication.Utilities.getMatrixValues(oBPGrid, "V_12", intLoop) 'oCombobox.Selected.Description
                    Else
                        strPrjCode = ""
                        strprojectname = ""
                    End If
                    ...
                    If strEmpid1 = "" Then
                        strEmpid1 = strEmpID
                    End If
                    ot.DoQuery("Select isnull(firstName,'') + ' ' + isnull(middleName,'')+' '+isnull(lastName,'') from OHEM where ""empID""=" & strEmpid1)
                    strEmployeename = ot.Fields.Item(0).Value
                    ...
                    If strDocref <> "" Then
                        If strLineCode = "" Then
                            ...
                            ousertable.UserFields.Fields.Item("U_Z_ATTACHMENT1").Value = oApplication.Utilities.getMatrixValues(oBPGrid, "V_51", intLoop)
                            If ousertable.Add <> 0 Then
                                oApplication.Utilities.Message(oApplication.Company.GetLastErrorDescription, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                Return False
                            Else
                                CopyAttachment(oApplication.Utilities.getMatrixValues(oBPGrid, "V_51", intLoop))
                            End If
                        Else
            ...
            oTempRec.DoQuery("Delete from [@Z_EXP1] where Name like '%_XD'") ' and U_Z_RefCode='" & strDocref & "'")
        End If
...
#Region "ShowFileDialog"
    ...
    Private Sub FileOpen()
        Dim mythr As New System.Threading.Thread(AddressOf ShowFileDialog1)
        mythr.SetApartmentState(Threading.ApartmentState.STA)
        mythr.Start()
        mythr.Join()
    End Sub

    Private Sub ShowFileDialog1()
...
#End Region
    ...
    Private Sub CopyAttachment(ByVal aFileName As String)
        If aFileName = "" Then
            Exit Sub
        End If
        For i As Integer = 1 To 1 'oMatrix.VisualRowCount
            Dim oRec As SAPbobsCOM.Recordset
            oRec = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            Dim strQry = "Select AttachPath From OADP"
            oRec.DoQuery(strQry)
            Dim SPath As String = aFileName ' oApplication.Utilities.getMatrixValues(oMatrix, "V_1", i)
            If SPath = "" Then
            Else
                Dim DPath As String = ""
    ...
    Private Sub LoadAttachment(ByVal aForm As SAPbouiCOM.Form)
        ...
        For i As Integer = 1 To oMatrix.VisualRowCount
            ...
            If oMatrix.IsRowSelected(i) Then
                ...
                strFilename = oMatrix.Columns.Item("V_51").Cells.Item(i).Specific.value
                '   Dim file = New FileInfo(strFilename)
                '   strFilename = file.Name
                Dim SPath As String = oApplication.Utilities.getMatrixValues(oMatrix, "V_51", i)
                Dim DPath As String = ""
                If Not oRec.EoF Then
                    DPath = oRec.Fields.Item("AttachPath").Value.ToString()
                End If
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_ExpEntry Then
                    ...
                    Case True
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "12" And pVal.CharPressed <> 9 And (pVal.ColUID = "V_-2" Or pVal.ColUID = "V_20" Or pVal.ColUID = "V_6" Or pVal.ColUID = "V_21" Or pVal.ColUID = "V_0" Or pVal.ColUID = "V_1" Or pVal.ColUID = "V_2" Or pVal.ColUID = "V_3" Or pVal.ColUID = "V_4" Or pVal.ColUID = "V_5") Then
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_COMBO_SELECT
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                oMatrix = oForm.Items.Item("12").Specific
                                If pVal.ItemUID = "12" And (pVal.ColUID = "V_2" Or pVal.ColUID = "V_3" Or pVal.ColUID = "V_6") Then
                                    Dim stCode As String
                                    Try
                                        stCode = oApplication.Utilities.getMatrixValues(oMatrix, "V_4", pVal.Row)
                                        oCombobox = oMatrix.Columns.Item("V_7").Cells.Item(pVal.Row).Specific
                    ...
                    Case False
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_COMBO_SELECT
                                ...
                                If pVal.ItemUID = "12" And (pVal.ColUID = "V_3") Then
                                    ...
                                    Try
                                        ...
                                        stCode = oCombobox.Selected.Value
                                        If stCode = "N" Then
                                            oMatrix.Columns.Item("V_6").Cells.Item(pVal.Row).Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                                        End If
                                    Catch ex As Exception
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_DOUBLE_CLICK
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                If pVal.ItemUID = "12" And pVal.ColUID = "V_51" Then
                                    FileOpen()
                                    If 1 = 2 Then
                                    Else
                                        oApplication.Utilities.SetMatrixValues(oMatrix, "V_51", pVal.Row, strSelectedFolderPath)
                                    End If
                                End If
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                ElseIf pVal.ItemUID = "21" Then
                                    If oApplication.SBO_Application.MessageBox("Do you want to delete selected expense?", , "Yes", "N0") = 2 Then
                                        Exit Sub
                                    End If
                                    deleterow(oForm)
                                End If
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "12" And (pVal.ColUID = "V_20" Or pVal.ColUID = "V_21") And pVal.CharPressed = 9 Then
                                    If 1 = 1 Then
                                        ...
                                        If oCombobox.Selected.Value = "P" Then
                                            '  oCombobox = oMatrix.Columns.Item("V_2").Cells.Item(pVal.Row).Specific
                                            strProject = oApplication.Utilities.getMatrixValues(oMatrix, "V_2", pVal.Row) ' oCombobox.Selected.Value
                                            strprojectname = oApplication.Utilities.getMatrixValues(oMatrix, "V_12", pVal.Row) 'oCombobox.Selected.Description
                                            ...
                                            If strProject <> "" Then
                                                ...
                                                clsChooseFromList.BinDescrUID = oApplication.Utilities.getEdittextvalue(oForm, "4")
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        If pVal.ItemUID = "12" And pVal.ColUID = "V_2" Then
                                            val = oDataTable.GetValue("U_Z_PRJCODE", 0)
                                            val1 = oDataTable.GetValue("U_Z_PRJNAME", 0)
                                            oMatrix = oForm.Items.Item("12").Specific
                                            oApplication.Utilities.SetMatrixValues(oMatrix, "V_12", pVal.Row, val1)
