    ...
    Public Sub databound(ByVal objform As SAPbouiCOM.Form)
        Try
            ...
            If choice = "MODULE" Then
                ...
                If ItemCode <> "" And ItemCode <> "" Then
                    If Documentchoice = "" Then
                        ...
                        strSQL = "Select U_Z_MODNAME,sum(U_Z_HOURS) from " & CFLChoice & " where DocEntry= (Select DocEntry from [@Z_HPRJ] where U_Z_PRJCODE='" & ItemCode & "') group by U_Z_MODNAME"
            ...
            ElseIf choice = "ACTIVITY" Or choice = "ACTIVITY1" Or choice = "ACTIVITY2" Or choice = "ACTIVITY3" Then
                ...
                If ItemCode = "" Then
                    '   Dim stActQury As String = "Select U_Z_ACTNAME from [@Z_ACTIVITY] where U_Z_STATUS='N'"
                    ...
                    If Documentchoice = "" Then
                        ...
                        strSQL = "Select U_Z_ActName,U_Z_MODNAME,U_Z_Hours from " & CFLChoice & " where U_Z_MODNAME In (" & stModQury & ") and  U_Z_ACTNAME IN (" & stActQury & ") and  DocEntry= (Select DocEntry from [@Z_HPRJ] where U_Z_PRJCODE='" & ItemCode & "')"
                        dtTemp.ExecuteQuery(strSQL)
                        objGrid.DataTable = dtTemp
                    Else
                        ...
                        strSQL = "Select U_Z_ACTNAME,U_Z_MODNAME from ""@Z_Activity"" where   U_Z_ACTNAME IN (" & stActQury & ") and  (isnull(U_Z_MODNAME,'0')='0' or U_Z_MODNAME='" & Documentchoice & "')"
                        dtTemp.ExecuteQuery(strSQL)
                        objGrid.DataTable = dtTemp
                    End If
                    'strSQL = "Select U_BinCode,U_Descrip,U_OnHand from [@DABT_OITBL] where U_ItemCode='" & ItemCode & "'and  U_WhsCode='" & CFLChoice & "' Order by U_BinCode "
...
#Region "Item Event"
    ...
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        BubbleEvent = True
        If pVal.FormTypeEx = "frm_ACT" Then
                            ...
                            If CFLChoice <> "" Then
                                ...
                                If choice <> "" Then
                                    ...
                                    Else
                                        ...
                                        Else
                                            osourcegrid.DataTable.SetValue("U_Z_ACTNAME", sourcerowId, strSelectedItem1)
                                        End If
