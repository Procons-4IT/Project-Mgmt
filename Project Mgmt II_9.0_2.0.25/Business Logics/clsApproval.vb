...
#Region "FormatGrid"
    Private Sub FormatGrid(ByVal aGrid As SAPbouiCOM.Grid, ByVal aChoice As String)
        ...
        Select Case aChoice
            Case "E"
                aGrid.Columns.Item("U_Z_EMPCODE").TitleObject.Caption = "Resource / Contractor Code"
                ...
                aGrid.Columns.Item("U_Z_EMPNAME").TitleObject.Caption = "Resource Name / Contractor Name"
                ...
                aGrid.Columns.Item("U_Z_LOCAMT").TitleObject.Caption = "Local Currency Amount (" & LocalCurrency & ")"
                aGrid.Columns.Item("U_Z_LOCAMT").Editable = False

                aGrid.Columns.Item("U_Z_SYSAMT").TitleObject.Caption = "System Currency Amount (" & systemcurrency & ")"
                aGrid.Columns.Item("U_Z_SYSAMT").Editable = False
                oEditTextColumn = aGrid.Columns.Item("U_Z_LOCAMT")
                oEditTextColumn.ColumnSetting.SumType = SAPbouiCOM.BoColumnSumType.bst_Auto
                oEditTextColumn = aGrid.Columns.Item("U_Z_SYSAMT")
                oEditTextColumn.ColumnSetting.SumType = SAPbouiCOM.BoColumnSumType.bst_Auto
                aGrid.Columns.Item("U_Z_DOCNUM").TitleObject.Caption = "Journal Reference"
                aGrid.Columns.Item("U_Z_DOCNUM").Editable = False
                aGrid.Columns.Item("U_Z_DisRule").TitleObject.Caption = "Distribution Rule"
                aGrid.Columns.Item("U_Z_DisRule").Editable = True
                oEditTextColumn = aGrid.Columns.Item("U_Z_DisRule")
                oEditTextColumn.ChooseFromListUID = "CFL1"
                ' oEditTextColumn.ChooseFromListAlias = ""
            ...
            Case "T"
                ...
                aGrid.Columns.Item("U_Z_CNTID").Editable = False
                aGrid.Columns.Item("TType").TitleObject.Caption = "Type"
                aGrid.Columns.Item("TType").Editable = False
                aGrid.Columns.Item("TType").Type = SAPbouiCOM.BoGridColumnType.gct_ComboBox
                ocombo = aGrid.Columns.Item("TType")
                ocombo.ValidValues.Add("E", "Employee")
                ocombo.ValidValues.Add("C", "Sub-Contractor")
                ...
                aGrid.Columns.Item("U_Z_EMPCODE").TitleObject.Caption = "Resource Code"
                aGrid.Columns.Item("U_Z_EMPCODE").Editable = False
                oEditTextColumn = oGrid.Columns.Item("U_Z_EMPCODE")
                oEditTextColumn.LinkedObjectType = "171"
                aGrid.Columns.Item("U_Z_EMPNAME").TitleObject.Caption = "Resource Name"
                aGrid.Columns.Item("U_Z_EMPNAME").Editable = False
                aGrid.Columns.Item("U_Z_DOCDATE").TitleObject.Caption = "Document Date"
                aGrid.Columns.Item("U_Z_DOCDATE").Editable = False
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If strCode <> "" Then
                ...
                Catch ex As Exception
                    strremarks = oGrid.DataTable.GetValue("U_Z_REMARKS", intRow)
                End Try
                If aForm.Title = "Time Sheet Approval" Then
                    strSQL = "Update " & strtable & " set U_Z_Remarks='" & strremarks & "', U_Z_Approved='" & strChoice & "'," & strField & "=" & strValue & " where Code='" & strCode & "'"
                ElseIf aForm.Title = "Expenses Approval" Then
                    strSQL = "Update " & strtable & " set U_Z_DisRule='" & oGrid.DataTable.GetValue("U_Z_DisRule", intRow) & "', U_Z_Remarks='" & strremarks & "', U_Z_Approved='" & strChoice & "'," & strField & "=" & strValue & " where Code='" & strCode & "'"
                Else
                    strSQL = "Update " & strtable & " set  U_Z_Remarks='" & strremarks & "', U_Z_Approved='" & strChoice & "'," & strField & "=" & strValue & " where Code='" & strCode & "'"
                ...
                If aForm.Title = "Expenses Approval" Then
                    oApplication.Utilities.updatelocalamount_Approval(strCode)
                End If
                If aForm.Title = "Time Sheet Approval" Then
                    ...
                    Case True
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ColUID = "U_Z_DisRule" Then
                                    BubbleEvent = False
                                    Exit Sub
                                End If
                                If pVal.ColUID <> "RowsHeader" Then
                                    Try
                                        ...
                                        If oGrid.DataTable.GetValue("U_Z_DOCNUM", pVal.Row) <> "" Then
                                            BubbleEvent = False
                                            Exit Sub
                                        End If
                                    Catch ex As Exception
