...
#Region "Methods"
    ...
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_Contract) = False Then
        ...
        oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PAT2")
        For count = 1 To oDataSrc_Line.Size - 1
            oDataSrc_Line.SetValue("LineId", count - 1, count)
        Next
        oMatrix = oForm.Items.Item("grdEmp").Specific
        oMatrix.AutoResizeColumns()
        oMatrix.SelectionMode = SAPbouiCOM.BoMatrixSelect.ms_Single
    ...
    Private Sub AddRow(ByVal aForm As SAPbouiCOM.Form)
        Select Case aForm.PaneLevel
            Case "1"
                ...
                oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PAT1")
            Case "8"
                oMatrix = aForm.Items.Item("grdEmp").Specific
                oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PAT2")
        End Select
        Try
            aForm.Freeze(True)
                    ...
                    Case True
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CLICK
                                ...
                                oMatrix = oForm.Items.Item("42").Specific
                                If (pVal.ItemUID = "42" Or pVal.ItemUID = "grdEmp") And pVal.Row > 0 Then
    ...
    Private Sub LoadGridValues(ByVal aForm As SAPbouiCOM.Form)
        ...
        Try
            ...
            If strProject <> "" Then
                ...
                If otest1.RecordCount > 0 Then
                    strProject = otest1.Fields.Item("DocNum").Value
                    strCardCode = otest1.Fields.Item("U_Z_CARDCODE").Value
                Else
                    strProject = ""
                    strCardCode = ""
                End If
            ...
            If strCardCode <> "" Then
                ...
                oTest.DoQuery("Select CardName from OCRD where CardCode='" & strCardCode & "'")
                oApplication.Utilities.setEdittextvalue(aForm, "10", oTest.Fields.Item(0).Value)
            End If
            LoadDocuments(aForm)
            oGrid = aForm.Items.Item("grdRes").Specific
            FormatGrid(aForm, oGrid, "R")
